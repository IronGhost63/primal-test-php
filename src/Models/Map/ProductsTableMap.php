...
class ProductsTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = '.Map.ProductsTableMap';
     ...
     */
    public const OM_CLASS = '\\App\\Model\\Products';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'Products';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['Id', 'Title', 'Description', 'Price', ],
        self::TYPE_CAMELNAME     => ['id', 'title', 'description', 'price', ],
        self::TYPE_COLNAME       => [ProductsTableMap::COL_ID, ProductsTableMap::COL_TITLE, ProductsTableMap::COL_DESCRIPTION, ProductsTableMap::COL_PRICE, ],
        self::TYPE_FIELDNAME     => ['id', 'title', 'description', 'price', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['Id' => 0, 'Title' => 1, 'Description' => 2, 'Price' => 3, ],
        self::TYPE_CAMELNAME     => ['id' => 0, 'title' => 1, 'description' => 2, 'price' => 3, ],
        self::TYPE_COLNAME       => [ProductsTableMap::COL_ID => 0, ProductsTableMap::COL_TITLE => 1, ProductsTableMap::COL_DESCRIPTION => 2, ProductsTableMap::COL_PRICE => 3, ],
        self::TYPE_FIELDNAME     => ['id' => 0, 'title' => 1, 'description' => 2, 'price' => 3, ],
        self::TYPE_NUM           => [0, 1, 2, 3, ]
    ];
    ...
    public function initialize(): void
    {
        ...
        $this->setClassName('\\App\\Model\\Products');
        $this->setPackage('');
        ...
        $this->addColumn('price', 'Price', 'DECIMAL', true, 24, null);
    }
     ...
     */
     public static function doDelete($values, ?ConnectionInterface $con = null): int
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \App\Model\Products) { // it's a model object
